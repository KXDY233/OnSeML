...
para.filename = 'Corel5k'; %Corel5k, bibtex delicious mediamill
...
para.low_dim = 10;
para.lambda = 0.001;
para.blsize = 100000; %round(0.05*num_data);
para.basize = 100000;
para.qsize = 5;
...
for i = 2:num_data 
    ...
    A = (Di - y_avg*x_avg') * inv(Ci - x_avg*x_avg' + 0.001* eye(size(Ci,1)));
    b = y_avg - A * x_avg;
    tY = A * dataX(:,i) + b;
    Yq(:,i) = tY;
    Yj(:,i)  = tQ * tY;
