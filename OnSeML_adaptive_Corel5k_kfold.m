...
parfor it = 1:5
    ...
    %     tQ = dataY(:, label_budget) * tH' / (tH * tH' + 0.001 * eye(para.low_dim)) ;
    ...
    for i = 2:num_data
        ...
        A = (Di - y_avg*x_avg') * pinv(Ci - x_avg*x_avg' + 0.01 * eye(size(Ci,1)));
        b = y_avg - A * x_avg;
        tY = A * dataX(:,i) + b;
        Yq(:,i) = tY;
        Yj(:,i)  = tQ * tY;
...
save corel5k_adaptive_0.2new.mat
